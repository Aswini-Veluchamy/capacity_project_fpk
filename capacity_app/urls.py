...
urlpatterns = [
    ...
    path('completed_financial_approval/<str:pk>', views.completed_financial_approval,
         name='completed_financial_approval'),
    ...
    path('completed_procurement_approval/<str:pk>', views.completed_procurement_approval,
         name='completed_procurement_approval'),
    path('procurement_completed_request/', views.procurement_completed_request,
         name='procurement_completed_request'),
    ...
    path('project_completed_request/<str:pk>', views.project_completed_request, name='project_completed_request'),
]